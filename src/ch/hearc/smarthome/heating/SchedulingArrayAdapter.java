	...
	public class SchedulingArrayAdapter extends ArrayAdapter<Schedulings> {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent){
	    	...
	    	if(row == null){
	            ...
	            holder.name = (TextView)row.findViewById(R.id.scheduling_list_item_name);
	            holder.date = (TextView)row.findViewById(R.id.scheduling_list_item_date);
	            holder.temp = (TextView)row.findViewById(R.id.scheduling_list_item_temp);
