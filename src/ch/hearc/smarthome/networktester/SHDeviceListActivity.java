...
public class SHDeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b_device_list_scan = (Button) findViewById(R.id.b_device_list_scan);
        ...
        ListView pairedListView = (ListView) findViewById(R.id.lv_device_list_paired_devices);
        pairedListView.setAdapter(mPairedDevicesArrayAdapter);
        pairedListView.setOnItemClickListener(mDeviceClickListener);

        // Find and set up the ListView for newly discovered devices
        ListView newDevicesListView = (ListView) findViewById(R.id.lv_device_list_new_devices);
